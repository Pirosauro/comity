import type { LazyContract } from "./contract.js";
 ...
 * ```
 */
export class Lazy<T> implements LazyContract<T> {
  /** Cached value after instantiation */
  #value?: T;
   ...
   */
  get value(): T {
    // Instantiate and cache the value on first access
