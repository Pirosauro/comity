...
describe("ServiceFlags", () => {
  it("should have correct bitwise flag values", () => {
    expect(ServiceFlags.TRANSIENT).toBe(0);
...
describe("Container", () => {
  ...
  describe("register()", () => {
    ...
    it("should register a service with transient flags", () => {
      ...
      container.register("testService", factory, ServiceFlags.TRANSIENT);
  ...
  describe("get()", () => {
    ...
    it("should create new transient service instance on each call", () => {
      ...
      container.register("transientService", factory, ServiceFlags.TRANSIENT);
  ...
  describe("has()", () => {
    ...
    it("should return true for both singleton and transient services", () => {
      ...
      container.register("transient", () => ({}), ServiceFlags.TRANSIENT);
