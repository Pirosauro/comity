...
| **Integration Adapters** | `@comity/storefront-magento`                                                                                                                                                                                                                                                                                                                                                                                                    | One external platform to one or more Core Module contracts (ADR-007). |
...
| Adapter classification (1 Integration + 15 Technology)                                                 | Conform                                              |
| Adapter → Adapter edges                                                                                | None present                                         |
| `type: module`, `engines.node >= 24.0.0`, `license`                                                    | Conform (all 43 packages)                            |
| README date format `YYYY-MM-DD`                                                                        | **Non-conforming** (35 READMEs use non-ISO dates)    |
| README `## Public API` "No exhaustive reference" line                                                  | **Non-conforming** (23 of 43 packages missing)       |
